...
SRCS = src/ft_isalpha.c src/ft_isalnum.c src/ft_isascii.c src/ft_isdigit.c src/ft_isprint.c src/ft_isalpha.c \
src/ft_tolower.c src/ft_toupper.c src/ft_split.c src/ft_strdup.c src/ft_strjoin.c src/ft_strlcat.c \
